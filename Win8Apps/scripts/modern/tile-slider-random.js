...
$.easing.easeInOutQuad = function (x, millisecondsSince, startValue, endValue, totalDuration) {
    if ((millisecondsSince /= totalDuration / 2) < 1) return endValue / 2 * millisecondsSince * millisecondsSince + startValue;
    return -endValue / 2 * ((--millisecondsSince) * (millisecondsSince - 2) - 1) + startValue;
};
    ...
    $.tileBlockSlider = function(element, options) {
        ...
        var slideBlock = function() {
            ...
            if (currentBlockIndex >= blocks.length) {
                var nextSlideTime = Math.random() * 60 * 1000;
                setTimeout(function() {
                    slideBlock();
                }, nextSlideTime);
            ...
            options = {
                ...
                easing: 'easeInOutQuad',//'doubleSqrt'
            };
